# 📚 Estructura Completa de Documentación - REFORMA

## 🎯 Estructura Frontend (`docs/`)
...
│   └── COMO_INICIAR.md
│
├── 📋 01-PLANES-IMPLEMENTACION/          # Planes de desarrollo
...
│
├── 🧪 02-PLANES-TESTEO/                  # Planes de testing
│   └── PLAN_TESTEO_Y_FUNCIONALIDADES_PENDIENTES.md
│
├── 💼 03-PLANES-NEGOCIO/                 # Estrategias de negocio
...
│
├── 🏗️ 04-ARQUITECTURA/                   # Arquitectura técnica
...
│
├── 🔧 05-PROPUESTAS-TECNOLOGIAS/         # Análisis tecnológico
│   ├── ALTERNATIVAS_STRIPE_ARGENTINA.md
│   ├── STRIPE_ARGENTINA.md
│   └── COSTOS_GOOGLE_OAUTH.md
│
├── 📖 06-GUIAS/                          # Guías paso a paso
...
│
├── 📝 07-RESUMENES/                      # Resúmenes de implementación
...
│
├── ⚙️ 09-SISTEMAS/                       # Sistemas específicos
│   └── SISTEMA_ELIMINACION_DEMO.md
│
└── 📄 ARCHIVOS-GENERALES/                # Documentos generales
    ├── README.md
    ├── README_BACKEND.md
    ├── CREDENCIALES_USUARIOS.md
    ├── INDICE_DOCUMENTACION.md
    ├── PROPUESTA_CATEGORIZACION.md
    ├── ESTRUCTURA_DOCUMENTACION.md
    ├── ESTRUCTURA_COMPLETA.md
    └── RESUMEN_REORGANIZACION.md
```

## 🎯 Estructura Backend (`backend/docs/`)

```
backend/docs/
├── 📖 00-INICIO/
│   └── README.md                         # Índice principal backend
│
...
│
├── 🔌 05-API/                            # (vacía - pendiente)
│   └── [RUTAS_API.md y SISTEMA_INVENTARIO.md deberían estar aquí]
│
├── 📖 06-GUIAS/
│   ├── DEPLOYMENT.md
│   ├── CONFIGURACION_STRIPE.md
│   ├── GUIA_OPTIMIZACIONES.md
│   ├── OPTIMIZACIONES_COMPRA_DETALLE.md
...
- **Total Frontend:** ~55 documentos organizados
- **Total Backend:** ~19 documentos organizados
- **Categorías principales:** 10 (frontend) + 8 (backend)
- **Subcategorías:** 3 (en GUIAS)

## 🔍 Cómo Encontrar Documentos

### Por Tema:
- **Configuración:** `06-GUIAS/CONFIGURACION/`
- **Desarrollo:** `06-GUIAS/DESARROLLO/`
- **Problemas:** `06-GUIAS/TROUBLESHOOTING/`
- **Planes de negocio:** `03-PLANES-NEGOCIO/`
- **Arquitectura:** `04-ARQUITECTURA/`
- **Testing:** `02-PLANES-TESTEO/`

### Por Tipo:
- **Inicio rápido:** `00-INICIO/`
- **Implementación:** `01-PLANES-IMPLEMENTACION/`
- **Resúmenes:** `07-RESUMENES/`
- **Estados:** `08-ESTADO/`
- **Sistemas:** `09-SISTEMAS/`
